...
const allQuestions = [
    ...
    { text: 'Год проведения ЧМ по футболлу в России', answers: ['2020', '2016', '2021', '2018'], correct: 3 },
    { text: 'Какая планета самая большая?', answers: ['Земля', 'Марс', 'Юпитер', 'Сатурн'], correct: 2 },
    { text: 'Какое животное является символом РМ?', answers: ['Бобер', 'Лиса', 'Волк', 'Ласка'], correct: 1 },
    { text: 'Кто написал роман "Война и мир"?', answers: ['Ф. Достоевский', 'Л. Толстой', 'А. Чехов', 'И. Тургенев'], correct: 1 },
    { text: 'Сколько основных нот в музыке?', answers: ['5', '7', '6', '8'], correct: 1 },
    ...
    { text: 'Какое из этих животных является млекопитающим?', answers: ['Крокодил', 'Пингвин', 'Дельфин', 'Акула'], correct: 2 },
    { text: 'Как называется самая высокая гора в мире?', answers: ['Эверест', 'Килиманджаро', 'Эльбрус', 'Монблан'], correct: 0 },
    { text: 'Какой прибор используется для измерения температуры?', answers: ['Барометр', 'Спидометр', 'Термометр', 'Гигрометр'], correct: 2 },
    { text: 'Какой металл самый лёгкий?', answers: ['Железо', 'Алюминий', 'Литий', 'Медь'], correct: 2 },
    { text: 'Как называются нежелательные рекламные сообщения, приходящие по электронной почте?', answers: ['Троян', 'Фишинг', 'Спам', 'Ботнет'], correct: 2 },
